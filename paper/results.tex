...
\newcommand{\VideoFeatureSet}{0.938}
\newcommand{\VideoFeatureCont}{0.931}
\newcommand{\VideoFeatureDelta}{0.007}
\newcommand{\VideoFeatureCI}{[0.005, 0.009]}
\newcommand{\FingerSetHV}{6.82}
\newcommand{\FingerContHV}{6.58}
\newcommand{\FingerHVDelta}{0.24}
\newcommand{\FingerHVCI}{[-0.01, 0.51]}
\newcommand{\FingerAccDelta}{2.48}
\newcommand{\FingerAccCI}{[0.97, 4.16]}
\newcommand{\FingerAngDelta}{-2.15}
\newcommand{\FingerAngCI}{[-3.75, -0.68]}
\newcommand{\FingerLeakDelta}{-3.74}
\newcommand{\FingerLeakCI}{[-5.85, -1.72]}
\newcommand{\FingerDetectionDelta}{3.29}
\newcommand{\FingerDetectionCI}{[1.96, 4.61]}
\newcommand{\FingerAccelDelta}{-0.086}
\newcommand{\FingerAccelCI}{[-0.165, -0.021]}
